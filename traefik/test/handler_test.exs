defmodule Traefik.HandlerTest do
  ...
  test "GET /about" do
    ...
    assert response == """
           ...
           <body>
           Lorem ipsum dolor sit amet, consectetur adipiscing elit. Suspendisse aliquam, odio et condimentum placerat, est mi laoreet felis, non placerat lorem orci at quam. Nulla nibh nulla, dapibus sed erat pellentesque, lacinia cursus sem. Phasellus suscipit ac libero at malesuada. Aliquam et accumsan justo, rhoncus lacinia nisi. Mauriss quis dui et massa commodo congue porta et turpis. Proin vitae semper sem, vel viverra magna. Nulla facilisi.
           </body>
           </html>
